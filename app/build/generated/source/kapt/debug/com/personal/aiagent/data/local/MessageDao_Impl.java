...
public final class MessageDao_Impl implements MessageDao {
  ...
  @Override
  public Flow<List<Message>> getMessagesByConversation(final String conversationId) {
      ...
      public List<Message> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Message(_tmpId,_tmpConversationId,_tmpRole,_tmpContent,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
